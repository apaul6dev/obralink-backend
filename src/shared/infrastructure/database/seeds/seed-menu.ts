...
import { MenuCode, PermissionCode } from '../../../../modules/identity/domain/constants';
...
const menuSeeds: MenuSeed[] = [
  ...
  {
    code: MenuCode.Companies,
    titleKey: 'nav.companies',
    routerLink: '/companies',
    icon: 'business',
    parentCode: MenuCode.Administration,
    displayOrder: 10,
  ...
  },
  {
    ...
    permissions: [PermissionCode.UiUsersView],
  },
  {
    code: MenuCode.Branches,
    ...
    permissions: [PermissionCode.UiBranchesView],
  },
  {
    code: MenuCode.Roles,
    titleKey: 'nav.roles',
    ...
    displayOrder: 30,
    allowedUserTypes: [UserType.SYSTEM_OWNER, UserType.COMPANY_ADMIN, UserType.BRANCH_ADMIN, UserType.COMPANY_USER],
    permissions: [PermissionCode.UiRolesView],
  },
  {
    code: MenuCode.MenuManagement,
  ...
  },
  {
    ...
    displayOrder: 45,
    allowedUserTypes: [UserType.SYSTEM_OWNER],
    permissions: [PermissionCode.UiModulesView],
  },
  {
    code: MenuCode.Permissions,
